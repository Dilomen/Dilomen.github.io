...
git add .
git commit -m '更新'
git push -f https://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@github.com/Dilomen/Blog.git master
# 确保脚本抛出遇到的错误
set -e 
...
git push -f https://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@github.com/Dilomen/Dilomen.github.io.git master
